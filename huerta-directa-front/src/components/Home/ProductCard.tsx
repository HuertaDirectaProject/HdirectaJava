      ...
      <div className="px-6 py-4 flex-grow flex flex-col justify-between">
        <div className="space-y-3">
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="space-y-1">
              <div className="flex flex-col gap-0.5">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-[13px] font-medium text-stone-400 dark:text-zinc-400">
                    / COP
                  </span>
                </div>
              </div>
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <span className="text-[10px] text-stone-400/50 dark:text-zinc-500 font-medium italic">
        ...
        <div className="grid grid-cols-5 gap-2 mt-4">
          ...
          <Button
            ...
            className="col-span-1 flex items-center justify-center bg-stone-100 dark:bg-zinc-800 text-stone-500 dark:text-zinc-400 rounded-xl hover:bg-[#8bc34a] hover:text-white transition-all py-2! px-2! gap-0! shadow-sm"
          />

          {/* Botón principal */}
          {isOwner ? (
             <div className="col-span-4 bg-gray-100 py-3 text-center text-gray-400 font-bold uppercase text-xs rounded-xl border border-gray-200">
                 Tu producto
             </div>
          ) : !hasStock ? (
            <Button
              text="Sin stock"
              disabled
              className="col-span-4 bg-gray-100 text-gray-400 py-3! px-6! rounded-xl flex items-center justify-center gap-3 text-xs font-bold"
            />
          ) : (
            <Button
              text="Agregar"
              ...
              className="col-span-4 bg-[#8bc34a] hover:bg-[#7cb342] text-white font-bold py-3! px-2! rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-[#8bc34a]/20 active:scale-95 text-xs uppercase tracking-wider"
            />
          )}
        </div>
      </div>
