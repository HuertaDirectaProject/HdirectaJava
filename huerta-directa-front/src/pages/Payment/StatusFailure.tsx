        ...
        <div className="min-h-screen bg-[#F5F0E8] py-8 px-4">
            <div className="max-w-xl mx-auto mt-16">
                <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
                    ...
                    <p className="text-gray-500 mb-8">Hubo un problema con tu pago. Por favor intenta de nuevo.</p>
                    <div className="flex gap-4 justify-center">
                        ...
                        <button
                            ...
                            className="px-8 py-3 bg-gray-400 hover:bg-gray-500 text-white font-bold rounded-xl transition-colors"
                        >
                            Volver a la tienda
                        </button>
                    </div>
